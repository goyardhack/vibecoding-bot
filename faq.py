...
_faq_data = json.loads((CONTENT_DIR / "faq.json").read_text(encoding="utf-8"))
FAQ_ITEMS: list[dict] = _faq_data["items"]
FAQ_BY_ID: dict[str, dict] = {item["id"]: item for item in FAQ_ITEMS}
